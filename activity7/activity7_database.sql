...
--
-- Host: localhost    Database: activity7
-- ------------------------------------------------------
...
INSERT INTO `migrations` VALUES (1,'0000_01_01_000000_create_groups_table',1),(2,'0001_01_01_000000_create_users_table',1),(3,'2026_03_06_013322_create_courses_table',1),(4,'2026_03_07_204716_create_students_table',1),(5,'2026_03_07_204716_create_teachers_table',1),(6,'2026_03_07_204717_create_administrators_table',1),(7,'2026_03_08_013902_create_robotics_kits_table',1),(8,'2026_03_09_013942_create_course_group_table',1);
...
CREATE TABLE `robotics_kits` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `robotics_kits_serial_number_unique` (`serial_number`),
  KEY `robotics_kits_course_id_foreign` (`course_id`),
  CONSTRAINT `robotics_kits_course_id_foreign` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-07 13:54:52
